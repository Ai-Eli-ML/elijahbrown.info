...
function LoginForm() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const redirect = searchParams.get('redirect') || '/ziva';
...
export default function ZivaLogin() {
  return (
    <div className={styles.container}>
      <div className={styles.loginCard}>
        <div className={styles.header}>
          <h1 className={styles.title}>Ziva Portal</h1>
          <p className={styles.subtitle}>Team workspace - password protected</p>
        </div>
