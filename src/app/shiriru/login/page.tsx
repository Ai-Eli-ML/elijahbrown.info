...
function LoginForm() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const redirect = searchParams.get('redirect') || '/shiriru';
...
export default function ShiriruLogin() {
  return (
    <div className={styles.container}>
      <div className={styles.loginCard}>
        <div className={styles.header}>
          <h1 className={styles.title}>Shiriru Portal</h1>
          <p className={styles.subtitle}>Password protected workspace</p>
        </div>
