...
function LoginForm() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const redirect = searchParams.get('redirect') || '/shirene';
...
export default function ShireneLogin() {
  return (
    <div className={styles.container}>
      <div className={styles.loginCard}>
        <div className={styles.header}>
          <h1 className={styles.title}>Shirene Portal</h1>
          <p className={styles.subtitle}>Account Manager workspace - password protected</p>
        </div>
