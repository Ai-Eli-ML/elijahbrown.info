...
function LoginForm() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const redirect = searchParams.get('redirect') || '/marika';
...
export default function MarikaLogin() {
  return (
    <div className={styles.container}>
      <div className={styles.loginCard}>
        <div className={styles.header}>
          <h1 className={styles.title}>Marika Portal</h1>
          <p className={styles.subtitle}>COO workspace - password protected</p>
        </div>
