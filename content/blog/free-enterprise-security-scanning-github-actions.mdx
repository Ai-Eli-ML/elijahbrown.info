...
The complete workflow is available on GitHub:
[security-scan.yml](https://github.com/AdvancingTechnology/Business-Ecosystem/blob/main/.github/workflows/security-scan.yml)
