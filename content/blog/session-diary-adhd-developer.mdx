...
**Phase 2** (next): Dashboard widget. My Personal Dashboard gets an "Active Work Streams" view showing all projects I've touched in the last 7 days, with pending tasks and last activity times.

**Phase 3** (coming): Discord bot integration. My C.O.O.L. bot can answer "@cool what was I working on?" by querying the diary table. My team can see what I've been up to without me having to remember.
